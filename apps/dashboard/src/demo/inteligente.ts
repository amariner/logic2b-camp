...
export const inteligenteRecommendationFixture = {
  ...
  title: 'Preparar un ajuste de tarifa para las últimas semanas de agosto',
  observation:
    'La ocupación prevista de Bungalow Laguna alcanza el 79 % en las dos últimas semanas de agosto y el 93 % de las reservas del periodo procede de la web.',
  recommendation:
    'Preparar una prueba limitada del 3 % de incremento en venta directa, solo para nuevas estancias de al menos 4 noches entre el 18 y el 31 de agosto.',
  evidence: {
    sellableUnits: 59,
    occupiedNights: 651,
    capacityNights: 826,
    occupancyPct: 79,
    overlappingBookings: 106,
    directWebBookings: 99,
    directWebSharePct: 93,
  },
  projection: {
    occupancyPctLow: 77,
    occupancyPctHigh: 83,
  ...
  confidence: {
    ...
    reasons: [
      ...
      'El canal directo representa 99 de las 106 reservas observadas',
  ...
  sources: [
    {
      ...
      value: '651 de 826 noches ocupadas',
