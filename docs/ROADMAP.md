...
| 6 · Dashboard | 🟨 Sesión 1/5 hecha | 2026-07-19 | ADR 0008: SPA en /admin/ del mismo Worker (hash history, cookie compartida), login Better Auth, planning v1 en lectura — filas virtualizadas, sticky, colores por estado con tokens, bloqueos, bandeja sin asignar, zoom 7/31/92 días. Verificado en navegador con el seed. Pendiente: DnD reasignación + ficha (17), solicitudes+llegadas=lite (18), reservas/inventario/tarifas (19), clientes/informes/ajustes (20) |
