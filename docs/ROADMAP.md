...
| 6 · Dashboard | 🟨 Sesiones 1–2/5 (planning ★ con DnD) | 2026-07-19 | ADR 0008: SPA en /admin/ del mismo Worker (hash history, cookie compartida), login Better Auth, planning v1 en lectura — filas virtualizadas, sticky, colores por estado con tokens, bloqueos, bandeja sin asignar, zoom 7/31/92 días. Verificado en navegador con el seed. Sesión 2: DnD de reasignación con pointer events, optimista+rollback en 409, teclado ↑/↓ — verificado contra el Worker. Pendiente: ficha/panel lateral (17), solicitudes+llegadas=lite (18), reservas/inventario/tarifas (19), clientes/informes/ajustes (20) |
