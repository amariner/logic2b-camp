...
**Orden**: C0 primero y no es negociable (el seed denso cambia cómo se ve todo lo demás; el HMR cambia la velocidad de todo lo demás). Luego C3 antes que C4 (lo transversal antes que lo profundo), con C2 en paralelo porque los alimenta.
