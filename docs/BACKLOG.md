...
- [9.x] `packages/cli` (`pnpm new:camping`): automatizar la Capa 1 del alta (D1, migración, seed, Worker, DNS) como subproceso de `wrangler` — diseñado en ADR 0012 §5, sin implementar (necesita ejecutarse contra la cuenta real de Cloudflare, con Andreu presente) — 2026-07-19
