...
- ~~[R12/pagos] Cerrar salidas Stripe y refund Redsys~~ → **hecho 2026-08-10 (sesiones 117 y 119)**: Stripe tiene timeout, clave estable, Zod y reintento seguro; Redsys exige sobre firmado, `0900`, pedido/importe exactos y no reintenta ambigüedades. Sigue pendiente tipar con Zod el callback Redsys, que hoy castea/coacciona sus campos, y confirmar en sandbox la versión de firma habilitada. Nada de esto acredita proveedor.
