...
- [R12/pagos] Cerrar la salida HTTP de Stripe: timeout, `Idempotency-Key` estable, respuesta Zod y error sin body/mensaje remoto; después validar el acuse funcional del refund Redsys, que hoy considera aceptado cualquier HTTP 2xx. Ambos son trabajo local previo al sandbox, no evidencia de proveedor — 2026-08-10
