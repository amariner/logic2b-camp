...
2. **Pagos:** Stripe ya cierra expiración de webhook y salida HTTP. Revisar en
   una entrega separada el acuse funcional del refund Redsys. Ninguna llamada
   sandbox sin credenciales y autorización.
