...
| **Analytics**                        | no; contrato inspecciona fuente y artefacto                    | n/a                                                       | n/a         | n/a                    | no hay captura, tracker, píxel ni CMP                | sí: ausente                                     | runbook R12            | **cierre local**; cuenta, finalidad, consentimiento y retención son gate |
...
`apps/web/scripts/r12-boundaries.mjs` convierte los cuatro estados finales en
contrato de build: inspecciona código, dependencias y artefacto; mantiene cierta
la política de cookies; exige observabilidad local redactada; rechaza conectores
