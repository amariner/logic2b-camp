...
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| **Inicio** (web + lead comercial) | Sitio bilingüe, formulario tipado, cuota 5/min, resultados `demo/delivered/disabled/failed`; adaptador HTTP de Resend. La demo responde `demo`, no finge entrega. No hay tabla de leads.                         | Logic2B: cuenta y `RESEND_API_KEY`, dominio `logic2b.com`, remitente y buzón; cliente: marca, legal, contenidos y destino si cambia.                           | DNS/SSL/SEO y responsive; envío real recibido; fallo devuelve 502+ref; rebote y spam revisados; privacidad/retención aprobadas.      | `LEADS_TRANSPORT=disabled` devuelve 503 explícito; volver DNS/contenido al artefacto anterior.                                 |
...
| **Comunicaciones**                | Plantillas, preferencias, `notifications_log`, estados `sent/failed/disabled` y recordatorios; Resend detrás de adaptador. Sin key queda apagado y no rompe reservas. No hay reintento de fallidos.              | Logic2B: cuenta/secret; cliente: dominio, remitente, destinatarios, idiomas, consentimientos y bajas; DNS SPF/DKIM/DMARC.                                      | Entrega controlada, bounce, opt-out, fallo de proveedor, reintento y logs sin PII indebida.                                          | Retirar `RESEND_API_KEY` deja `disabled`; desactivar tipos por configuración sin deploy.                                       |
