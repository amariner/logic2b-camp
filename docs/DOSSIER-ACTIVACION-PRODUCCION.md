...
| **SES.Hospedajes**                | Modelo, validación, XML/parte, descarga manual y adaptador de transporte; pruebas con endpoint simulado. Sin tres secrets cae a modo manual. **INE no está implementado.**                                                                                                                                                                                        | Cliente: alta/código del establecimiento y responsable; secrets `SES_HOSPEDAJES_ENDPOINT/USER/PASSWORD`; confirmar formato oficial vigente.                                                                          | Envío en entorno oficial si existe: aceptación, rechazo explicado, reintento, duplicado, trazabilidad y procedimiento manual.                                  | `manualTransport`: descargar y subir por el canal oficial; conservar evidencia sin reenvío automático.                         |
