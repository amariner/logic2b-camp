...
| **OTA / channel manager**         | **No hay conector ni sincronización real.** Mar de Fondo solo representa un escenario supervisado.                                                                                                                                                                                                                                                                | Cliente elige un proveedor/API y autoridad de inventario; contrato, credenciales, mapeos, límites y soporte.                                                                                                                          | Alta/cambio/cancelación, duplicados, caída, recuperación, conflictos y conciliación completa.                                                                  | Desactivar conector y volver al sistema elegido como autoridad; cola congelada y conciliada antes de reanudar.                 |
| **IA / automatización**           | Automatiza e Inteligente consumen fixtures/prototipos etiquetados; no llaman modelos ni ejecutan acciones externas. Hay contratos de interacción y confirmación humana, no backend de IA.                                                                                                                                                                         | Cliente define casos, datos, tolerancia, supervisor y presupuesto; Logic2B elige proveedor/modelo, permisos, evals y retención.                                                                                                       | Dataset y umbrales aprobados, permisos, coste/latencia, prompt injection, rechazo/fallback y confirmación humana demostrados.                                  | Interruptor global a modo manual; la operación base nunca depende del modelo.                                                  |
| **Copias / observabilidad**       | Logs JSON+referencia+redacción; avisos por email; export SQL+CSV. Restauración local 2026-08-10: 3426/2568/3109 e invariantes 0/0.                                                                                                                                                                                                                                | Cliente+Logic2B acuerdan RPO/RTO, contactos y retención. Cloudflare para restauración remota; destino/secret para canal externo independiente.                                                                                        | Restauración **remota** sobre base nueva, alerta recibida por canal independiente y simulacro fechado.                                                         | Export previo; nunca restaurar encima de la viva; repuntar binding solo tras verificar; bookmark de Time Travel para deshacer. |
